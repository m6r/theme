 ...
 * @uses m6r_header_style() to style front-end.
...
function m6r_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'm6r_header_style',
		'admin-head-callback'    => 'm6r_admin_header_style',
		'admin-preview-callback' => 'm6r_admin_header_image',
	);

	add_theme_support( 'custom-header', $args );
}
add_action( 'after_setup_theme', 'm6r_custom_header_setup' );
 ...
 */
function m6r_custom_header_fonts() {
	$font_url = m6r_get_font_url();
	if ( ! empty( $font_url ) )
		wp_enqueue_style( 'm6r-fonts', esc_url_raw( $font_url ), array(), null );
}
add_action( 'admin_print_styles-appearance_page_custom-header', 'm6r_custom_header_fonts' );
...
function m6r_header_style() {
	...
	?>
	<style type="text/css" id="m6r-header-css">
	<?php
...
?>
	<style type="text/css" id="m6r-admin-header-css">
